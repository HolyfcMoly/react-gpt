...
function Footer({padding, switchPadding}) {
    ...
    return (
        <div className="gpt3__footer ">
            <div className={`gpt3__footer-container container ${padding ? '' : 'switch-padding'}`}>
                ...
                <div className="gpt3__footer-container_content">
                    <div className="gpt3__footer-container_content-logo">
                    ...
                    <div className="gpt3__footer-container_content-menu">
